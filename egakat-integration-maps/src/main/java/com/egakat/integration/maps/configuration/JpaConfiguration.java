package com.egakat.integration.maps.configuration;
...
public class JpaConfiguration extends HikariConfig {
	...
	static final String PACKAGES_TO_SCAN_FOR_REPOSITORIES = "com.egakat.integration.maps.repository";

	static final String[] PACKAGES_TO_SCAN_FOR_ENTITIES = { "com.egakat.integration.maps.domain",
