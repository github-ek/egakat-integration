...
@NoArgsConstructor
@AllArgsConstructor
public class GrupoTipoArchivoDto extends BusinessEntityDto<Long> implements ObjectWithCode<Long>, SortableObject, InactivableObject {
	...
	@Builder
	public GrupoTipoArchivoDto(Long id, int version, String creadoPor, LocalDateTime fechaCreacion,
